...
//         if (!article.content) return null
//         return article.content.currentTopic
//     }, [article.content.currentTopicId])

//     const distanceToCurrentTopic = useMemo(() => {
//         if (!article.content) return null
//         return article.content.distanceToCurrentTopic(topic.order)
